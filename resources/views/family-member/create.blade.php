...
<div class="container mt-3">
    ...
    <Form action="{{route('familyMember.store')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-check-input ms-2" type="radio" name="gender" id='gender' value="female">
        ...
        <div class="form-group">
            ...
            <input type="text" name="learning_place_type" id="" onkeypress="return isTextKey(event)"
        ...
        <div class="form-group">
            ...
            <input type="text" name="monthly_income" id="" onkeypress="return isNumberKey(event)"
